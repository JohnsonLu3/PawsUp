        ...
        <div>
            <div id="sideMenu" className="hide">
                <span className="sideHeader">
                    <h2>Settings</h2>
                    <button onClick={hideMenu}><span className="sr">Hide Menu</span><FontAwesomeIcon icon={faTimes} />
                    </button>
                </span>
                ...
                <ul>
                    ...
                    <li>
                        <span id="locationContainer">
                            ...
                            <button onClick={findLocation} title="Find my Location"><span className="sr">Find my Location</span><FontAwesomeIcon icon={faGlobeAmericas} /></button>
                        </span>
                    </li>
...
function showPosition(position) {
    document.getElementById("locationError").innerHTML = "Latitude: " + position.coords.latitude +
